      ...
      {!list ? (
        <>
          ...
          <div style={{position:"fixed",bottom:0,left:0,right:0,background:"#fff",borderTop:"1px solid #E5E9EC",padding:"9px 12px",display:"flex",gap:7,zIndex:15}}>
            ...
            <button onClick={exportExcel} disabled={exporting} style={{flex:1.3,padding:11,borderRadius:9,border:0,background:"#F0A202",fontWeight:900,opacity:exporting?.7:1}}>{exporting ? "..." : "Excel"}</button>
